...
public class CursoController {
    ...
    //Alternativa I busqueda user solo por id
//    @GetMapping("/{id}")
...
//    }
    //Alternativa II - busqueda todos user por id
    @GetMapping("/{id}")
    public ResponseEntity<?> detalle(@PathVariable Long id) {
    ...
    //Metodos que entregan la dta al cliente ya realizado los cambios, combinando curso y usuario
